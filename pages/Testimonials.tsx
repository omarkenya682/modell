...
const Testimonials: React.FC<TestimonialsProps> = ({ settings }) => {
  ...
  // Use the video URL from settings, or fallback if not available
  const videoUrl = settings?.testimonialVideoUrl || "https://www.youtube.com/embed/dQw4w9WgXcQ?si=placeholder";
